...
Confirm that node is running in x64 by running `node -e 'console.log(process.arch)`

---

Connecting via the provided thin client results in `Error: NJS-500: connection to the Oracle Database was broken`

1. Download the Instant Client (Basic Light) and extract it in the directory of your choice (./lib/instant_client_19_8)
